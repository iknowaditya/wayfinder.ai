...
function footer() {
  return (
    <footer className="w-full bg-gray-100 :bg-gray-900 py-16">
      <div className="md:px-12 lg:px-28">
        <div className="container m-auto space-y-6 text-gray-600 :text-gray-300">
          <a
            href="/"
            aria-label="logo"
          ...
          <div className="text-center">
            <span className="text-sm tracking-wide">
              Copyright © wayfinder <span id="year"></span> | All right reserved
            </span>
          </div>
        </div>
      </div>
